...
const SCENARIOS: Scenario[] = [
  {
    ...
    keyThings: [
      "The first 72 hours after a hospitalization are critical for understanding discharge options — hospitals will begin discharge planning quickly, and you have the right to be part of that conversation.",
      ...
      "A Geriatric Care Manager is a professional who specializes in exactly this moment — they can assess needs, evaluate options, and guide your family through the immediate decisions.",
    ],
    questionGroups: [
      {
    ...
    steps: [
      ...
      "Begin gathering key documents: insurance cards, Medicare/Medicaid information, power of attorney if one exists.",
  ...
  },
  {
    ...
    keyThings: [
      ...
      "Medicaid for long-term care is different from regular Medicaid — it has specific asset and income rules, and a 60-month look-back period that examines financial transfers.",
      "You have the right to tour any licensed facility, review their state inspection reports, and ask detailed questions about staffing ratios and care practices.",
    ...
    steps: [
      "Assess your loved one's care needs honestly — Activities of Daily Living (ADLs) are the standard framework.",
      ...
      "Consult an Elder Law Attorney before making any significant financial moves — Medicaid planning requires professional guidance.",
    ],
    experts: ["Geriatric Care Manager", "Elder Law Attorney"],
  },
  {
    ...
    orientation:
      "Medicare and Medicaid are two entirely different programs that are endlessly confused with each other — and the confusion can cost families thousands of dollars and missed benefits. Medicare is federal health insurance primarily for people 65 and older. Medicaid is a joint federal-state program that pays for long-term care for those who qualify financially. Understanding the basics of both — and how they interact — is one of the most valuable things you can do for your family.",
    keyThings: [
      "Medicare has four parts: Part A (hospital), Part B (medical), Part C (Medicare Advantage plans), and Part D (prescription drugs) — each with its own costs, coverage, and enrollment rules.",
      "Missing Medicare enrollment windows can result in permanent premium penalties — knowing the timelines matters.",
      "Medicare does NOT cover long-term custodial care (help with bathing, dressing, eating) in a nursing home beyond a limited period — this surprises most families.",
      ...
      "Medicare Savings Programs can help lower-income Medicare beneficiaries with premiums and cost-sharing — many eligible people don't know they exist.",
    ],
    questionGroups: [
      {
        ...
        items: [
          ...
          "What is the difference between Original Medicare and Medicare Advantage for my needs?",
    ...
    steps: [
      ...
      "Review any upcoming enrollment windows (Initial Enrollment, General Enrollment, Special Enrollment).",
      "If long-term care costs are a concern, consult an Elder Law Attorney about Medicaid planning — the earlier the better.",
      "Check eligibility for Medicare Savings Programs through NJ's SHIP program (free counseling available).",
    ],
  ...
  },
  {
    ...
    keyThings: [
      "There are five essential documents every adult should have: a Will, a Durable Power of Attorney, a Healthcare Proxy (or Healthcare Power of Attorney), an Advance Directive (Living Will), and a HIPAA Authorization.",
      ...
      "A Durable Power of Attorney gives someone you trust the legal authority to manage your finances if you are unable to — without it, your family may need to go to court to get this authority.",
      "A Healthcare Proxy designates who can make medical decisions on your behalf if you cannot speak for yourself.",
      "An Advance Directive (Living Will) documents your wishes for end-of-life care — it removes an impossible burden from your family.",
      "Estate planning is not a one-time event — documents should be reviewed after major life changes (marriage, divorce, death of a named person, significant change in assets).",
    ],
    questionGroups: [
      {
  ...
  },
  {
    ...
    keyThings: [
      ...
      "The Executor named in the Will is responsible for managing the estate through probate — if there is no will, the court appoints an Administrator.",
      "NJ has an inheritance tax (not an estate tax) that applies to certain beneficiaries — a probate attorney can clarify what applies to your situation.",
      "Time-sensitive tasks in the first 30 days include: obtaining death certificates (you will need multiple copies), notifying Social Security and Medicare, contacting financial institutions, and securing the deceased's property and assets.",
      "Grief and administrative burden are a difficult combination — it is appropriate and advisable to get professional help, both emotional and legal.",
    ],
    questionGroups: [
      {
    ...
    steps: [
      ...
      "Notify Social Security Administration — if the deceased was receiving benefits, payments must stop and surviving spouse benefits may be available.",
      "Locate the Will and contact the named attorney or a probate attorney to begin the process.",
  ...
  },
  {
    ...
    orientation:
      "The families who navigate eldercare most successfully almost always have one thing in common: they started before they had to. Getting the right documents in place, having honest conversations, understanding what care options exist and how to pay for them — none of it is easy, but all of it is far easier before a crisis than during one. If you're reading this section, you're already ahead of most people. Here's how to make the most of that.",
    keyThings: [
      "A family care plan is a document that captures the aging person's wishes, medical information, key contacts, financial overview, and care preferences — creating one is the single most valuable planning exercise a family can do.",
      "Long-term care is expensive and Medicare does not cover most of it — understanding your options (long-term care insurance, hybrid life insurance policies, Medicaid planning, self-funding) before you need them is essential.",
      ...
      "Financial planning for eldercare is a specialty — not all financial advisors understand Medicaid rules, long-term care insurance, or elder-specific strategies.",
    ],
    questionGroups: [
      {
        ...
        items: [
          ...
          "Does our aging parent or spouse have all five essential documents in place and up to date?",
